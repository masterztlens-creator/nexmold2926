...
const html = ` <html> <head> <title>Engineering Guide</title> </head>
...
const html = ` <body> <header>Site Header</header>
...
const html = ` <body> <div class="cookie-banner">
We use cookies to improve your experience. </div>
...
const html = `     <main>       <p>
        Wall thickness &gt; 1&nbsp;mm &amp; uniform.       </p>     </main>
  `;
...
const html = `     <main>       <h1>Wall Thickness</h1>       <p>Wall thickness: 2 mm.</p>       <p>Clamp force 50 kN.</p>     </main>
  `;
...
const html = ` <main> <h1>Injection Molding</h1> <p>Wall thickness: 2 mm.</p>
...
const html = ` <nav>
target: polluted-navigation </nav>
...
const html = `     <header>HEADER</header>     <main>       <h1>DFM</h1>       <p>Wall thickness: 2 mm.</p>       <p>Draft angle: 1 mm.</p>     </main>     <footer>FOOTER</footer>
  `;
...
const html = ` <body> <div class="sidebar"> <div class="sidebar-inner">
Related article: polluted content. </div>
...
const html = ` <body> <div class="cookie-banner"> <div class="cookie-inner">
We use cookies. </div>
...
const html = ` <main> <article> <h1>Draft Angle Guidance</h1>
...
const html = ` <article> <h1>Injection Molding Process</h1>
...
const html = ` <body> <div role="complementary"> <div>
Recommended product: polluted-product. </div>
...
const html = ` <body> <div class="related-content"> <div class="related-inner">
Wall thickness: 999 mm. </div>
...
const html = ` <main> <p>target: first-authoritative-fact</p>
...
const html = ` <body> <article> <h1>Injection Molding Wall Thickness</h1>
...
const html = ` <main> <h1>Injection Molding Design Rules</h1>
...
const html = ` <body> <header> <div class="header-inner">
Header pollution. </div> </header>
...
* V8-22B-S3
*
* Regression fixture derived from the real Protolabs plastic-injection-
* molding page acquired during the V8 Internet acquisition audit.
*
* The page exposes commercially common UI blocks inside the main content
* region without semantic UI roles/classes that the current V8-22B
* subtree filter recognizes:
*
* * CTA: Request an online quote
* * CTA: Upload a Part / View Materials
* * compliance strip
* * jump navigation
* * quote CTA
*
* These blocks must not become MEDIUM structured-evidence candidates.
*
* The test intentionally does not reject legitimate prose containing words
* such as "quote" or "request". Only structurally isolated UI blocks are
* targeted here.
  */
  test("V8-22B-S3 rejects commercial CTA and jump-navigation blocks from structured evidence", () => {
  const html = `
  ...
  ```
     ...
     <h2>What is Plastic Injection Molding?</h2>
     ...
     <p>
       Plastic molding capabilities include important design considerations
       for moldability and production.
     </p>
...
const uiExactFragments = [
"Request an online quote.",
"Upload a Part View Materials",
"Certification + Compliance ISO 9001:2015 ISO 13485:2016 AS9100D CTQ Inspections ITAR",
"Jump to Section Capabilities Materials Surface Finishes Quality Inspections Finishing Options",
"Get an online quote.",
"Get a Quote",
];

for (const candidate of result) {
const normalizedExcerpt = candidate.excerpt
.replace(/\s+/g, " ")
.trim();

```
for (const uiFragment of uiExactFragments) {
  assert.notEqual(
    normalizedExcerpt,
    uiFragment,
    `Commercial UI block was promoted to structured evidence: ${normalizedExcerpt}`,
  );
}
```
...
assert.ok(authoritative.length >= 1);
