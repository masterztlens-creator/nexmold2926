/** NEXMOLD V7.15 — production boundary adapter. */
import { compileRegionalPage, type V714RegionalCompilerInput, type V714RegionalCompilerPublished } from "./regionalCompiler.ts";
import type { CanonicalUrl, RegionalCompileInput } from "./types.ts";
