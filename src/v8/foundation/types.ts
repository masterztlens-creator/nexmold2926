...
export interface AuditActor {
  readonly id: string;
  readonly role: "SYSTEM" | "INGESTOR" | "AUDITOR" | "VERIFIER";
}

export interface FoundationRecord<TPayload = unknown> {
...
export interface FoundationStore {
  append<T>(record: Omit<FoundationRecord<T>, "recordId" | "fingerprint" | "recordedAt" | "previousFingerprint"> & { readonly recordedAt?: string }): FoundationRecord<T>;
