  ...
  createKnowledge(
    ...
    const payload: KnowledgePayload =
      immutable({
        ...
        ...((prepared as any).isUniversal !== undefined
          ? {
              isUniversal:
                (prepared as any).isUniversal,
            }
          : {}),
      });
